...
def build(prs):
    ...
    # 23h) CATALOGO DE BLOQUES: la tanda v2 (NUEVO)
    # 24 bloques -> 2 diapositivas. Ejercita la paginacion con datos reales.
    s.add_blocks_grid(
        prs,
        "Bloques *especializados*",
        [
            ("booking-calendar", "Calendario de reservas",
             "Mes completo con dias disponibles."),
            ("time-slots", "Franjas horarias",
             "Huecos por dia, libres y ocupados."),
            ("opening-hours", "Horario de apertura",
             "Tabla de horarios con el dia de hoy."),
            ("multi-step-form", "Formulario por pasos",
             "Alta guiada con resumen lateral."),
            ("price-calculator", "Calculadora de precio",
             "Sliders y presupuesto en vivo."),
            ("product-configurator", "Configurador",
             "Preview, acabados y variantes."),
            ("stats-chart", "Grafico de barras",
             "Evolucion de una cifra en el tiempo."),
            ("donut-stats", "Anillos de progreso",
             "Porcentajes en formato anillo."),
            ("progress-bars", "Barras de progreso",
             "Nivel alcanzado por cada partida."),
            ("data-table", "Tabla de datos",
             "Filas ordenables y paginadas."),
            ("comparison-table", "Tabla comparativa",
             "Checks con una columna destacada."),
            ("property-map-list", "Listado + mapa",
             "Fichas a un lado, mapa al otro."),
            ("floor-plan", "Plano de planta",
             "Distribucion con cotas y estancias."),
            ("menu-carta", "Carta de restaurante",
             "Platos y precios a dos columnas."),
            ("lesson-player", "Reproductor de leccion",
             "Video y temario con progreso."),
            ("quiz", "Cuestionario",
             "Pregunta, opciones y avance."),
            ("event-countdown", "Cuenta atras",
             "Dias, horas y minutos al evento."),
            ("event-agenda", "Agenda del evento",
             "Franjas horarias y ponencias."),
            ("seat-picker", "Selector de butacas",
             "Mapa de sala con asientos libres."),
            ("chat-panel", "Panel de chat",
             "Conversacion y campo de entrada."),
            ("ai-search", "Busqueda con IA",
             "Respuesta generada con sus fuentes."),
            ("bento-grid", "Rejilla bento",
             "Celdas de tamanos desiguales."),
            ("marquee-band", "Cinta deslizante",
             "Etiquetas en movimiento continuo."),
            ("split-screen", "Pantalla partida",
             "Media foto a sangre, medio panel."),
        ],
        subtitle="Reservas, datos, sector y patrones modernos",
        page=n, section="BLOQUES",
    )
